                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <?php
                                            ...
                                            $comments = mysqli_num_rows($select_all_comments);
                                        ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <?php
                                            ...
                                            $users = mysqli_num_rows($select_all_users);
                                        ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <?php
                                            ...
                                            $categories = mysqli_num_rows($select_all_categories);
                                        ?>
                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            ...
                            <?php
                                ...
                                $element_count = [$posts, $posts_draft, $comments, $comments_unapproved, $users, $users_sub, $categories];
